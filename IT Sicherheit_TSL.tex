...
\author{\IEEEauthorblockN{1\textsuperscript{st} Sina ??}
\IEEEauthorblockA{\textit{HKA} \\
\textit{Hochschule Karlsruhe}\\
reni1030@h-ka.de}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Person 2}
\IEEEauthorblockA{\textit{HKA} \\
\textit{Hochschule Karlsruhe}\\
reni1030@h-ka.de}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Person 3}
\IEEEauthorblockA{\textit{HKA} \\
\textit{Hochschule Karlsruhe}\\
reni1030@h-ka.de}
\and
...
\begin{abstract}lat
Erläutern Sie die Funktionsweise von TLS, insbesondere den Handshake-Prozess, Zertifikatsprüfung und Vertrauensketten. 
Entwerfen Sie ein Szenario mit mindestens zwei Client-Server-Paaren mit unterschiedlichen TLS-Konfigurationen (z. B. sichere Konfiguration, veraltete Version, schwache Cipher Suite oder selbstsigniertes Zertifikat). 
...
\begin{IEEEkeywords}
TLS, Sicherheit, Authentizität, Hacking
\end{IEEEkeywords}
